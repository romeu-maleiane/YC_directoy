...
import Views from "@/components/views/page"
...
export default async function StartupDetails({ params }: {params: Promise<{ id: string}>}){
    ...
    const md = markdownit()
        ...
        const parsePitch = md.render(post?.pitch || '')
    return <>
        ...
        <section className="section_container">
            ...
            <div className="space-y-5 mt-10 max-w-4xl mx-auto">
                ...
                {parsePitch ? (
                    ...
                    dangerouslySetInnerHTML={{__html: parsePitch}}
                    />
                ) : (
        ...
        
        {
            editorPost?.length > 0 && (
                <div className="max-w-4xl mx-auto">
                    <p className="text-38-semibold">Editor Picks</p>
